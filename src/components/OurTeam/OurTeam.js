        ...
        <>
            ...
            <div>
                ...
                <div className='flex justify-center mt-2'>
                    <p className='border-2 border-blue-500 w-[50px] h-[50px] text-4xl flex justify-center items-center rounded-full text-blue-500'>
                        <AiOutlineGooglePlus></AiOutlineGooglePlus>
                    </p>
                    <p className='border-2 text-red-500 border-red-500 w-[50px] h-[50px] text-3xl flex justify-center items-center rounded-full ml-3'>
                        <FaFacebookF></FaFacebookF>
                    </p>
                    <p className='border-2 w-[50px] h-[50px] text-3xl flex justify-center items-center rounded-full text-cyan-500 border-cyan-500 ml-3'>
